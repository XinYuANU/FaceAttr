...
locnet:add(cudnn.SpatialConvolution(256,128,3,3,1,1,1,1))
locnet:add(cudnn.ReLU(true))
locnet:add(cudnn.SpatialMaxPooling(2,2))
locnet:add(cudnn.SpatialConvolution(128,64,3,3,1,1,1,1))
locnet:add(cudnn.ReLU(true))
locnet:add(cudnn.SpatialMaxPooling(2,2))
locnet:add(cudnn.SpatialConvolution(64,20,3,3, 1,1,1,1))
locnet:add(cudnn.ReLU(true))
locnet:add(cudnn.SpatialMaxPooling(2,2))
