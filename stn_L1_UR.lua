...
locnet:add(cudnn.SpatialConvolution(8,64,5,5))
locnet:add(cudnn.ReLU(true))
locnet:add(cudnn.SpatialMaxPooling(2,2,2,2))  -- 14
locnet:add(cudnn.SpatialConvolution(64,128,3,3))
locnet:add(cudnn.ReLU(true))
locnet:add(cudnn.SpatialMaxPooling(2,2,2,2))  -- 6
